const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-jVK3RL5F.js","assets/index-DFyW9aWf.js","assets/index-BdQa4w6p.css","assets/OutputColorHighlightOID.glsl-DEOUXTjO.js","assets/videoUtils-CJF26WFq.js","assets/requestImageUtils-DT1_THpZ.js","assets/basicInterfaces-N86vRvDz.js","assets/TextureFormat-1mYWTFa-.js","assets/BufferView-Ch9dAkTl.js","assets/mat4f64-q_b6UJoq.js","assets/Indices-BSJchYba.js","assets/triangle-CDn9ykqh.js","assets/sphere-CZKeQFHd.js","assets/mat3f64-B5o_lm6j.js","assets/vectorStacks-BzB229wG.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-9nZoS2WH.js","assets/VertexAttribute-BfkzOMLV.js","assets/glsl-Cj7KC756.js","assets/BindType-BBwFZqyN.js","assets/ShaderOutput-Bdd80V3g.js","assets/renderState-zVCpbKXd.js","assets/orientedBoundingBox-B2bcnNYj.js","assets/quat-DwYFWjBf.js","assets/spatialReferenceEllipsoidUtils-D8EWNvkF.js","assets/computeTranslationToOriginAndRotation-iV5qSWJT.js","assets/plane-CNEp_gZs.js","assets/boundedPlane-D30gvytE.js","assets/projectVectorToVector-MDTYfpY9.js","assets/projectPointToVector-tH3B4WDW.js","assets/ShaderBuilder-igZMacRA.js","assets/DefaultMaterial-BJK77_Mi.js","assets/InterleavedLayout-BL0L1SOD.js","assets/types-BKo2foNY.js","assets/NormalAttribute.glsl-Ei8ZVpaV.js","assets/dehydratedFeatureUtils-BsgWCSUx.js","assets/meshVertexSpaceUtils-yFZXQeZK.js","assets/MeshLocalVertexSpace-B9fwR4UR.js","assets/hydratedFeatures-C-ryOk6P.js","assets/vec3f32-WCVSSNPR.js"])))=>i.map(i=>d[i]);
import{nT as Se,S as Re,gg as Pe,nU as ut,jr as Ae,nV as dt,ax as ft,ho as pt,_ as ht,jg as Fe,jx as gt,v as P,mj as Ie,hk as Xe,ez as le,cO as G,ex as Z,cM as xe,eh as We,ek as q,jD as pe,nW as ke,cT as Qe,cE as X,ev as te,eA as Ze,aX as vt,ej as Ee,f8 as mt,b6 as St,hg as xt,c_ as bt,cQ as Ct,nX as Ot,cG as $t}from"./index-DFyW9aWf.js";import{o as Tt}from"./floatRGBA-DliGnRRK.js";import{i as Pt,L as At,a as Et,m as yt,s as zt,b as Rt,e as Ft,c as It,o as wt,d as we,f as ge,g as _e,h as De,w as _t,t as Dt,j as Mt,k as H,l as jt,q as Lt,r as Nt,u as K,v as Ut,x as Bt,F as Vt,y as qt,z as Ht,A as Gt,B as Xt,C as A,D as Wt,E as Q,G as kt,H as Ye,I as Je,J as Qt,K as Zt,M as Yt,N as Jt,O as Kt,R as eo,S as to,P as oo,Q as io,T as Me,U as je,V as ao,W as so,X as Le}from"./OutputColorHighlightOID.glsl-DEOUXTjO.js";import{e as Ke}from"./mat3f64-B5o_lm6j.js";import{e as ro}from"./mat4f64-q_b6UJoq.js";import{s as no,g as lo,o as Ne,f as co,y as uo,T as Ue}from"./BufferView-Ch9dAkTl.js";import{O as fo}from"./InterleavedLayout-BL0L1SOD.js";import{n as N,u as et,w as ve}from"./ShaderOutput-Bdd80V3g.js";import{l as tt,u as po,n as ho,t as go,d as vo}from"./dehydratedFeatureUtils-BsgWCSUx.js";import{e as d}from"./VertexAttribute-BfkzOMLV.js";import{n as f,t as y}from"./glsl-Cj7KC756.js";import{a as mo}from"./BindType-BBwFZqyN.js";import{i as So}from"./ShaderBuilder-igZMacRA.js";import{B as xo,o as bo,g as Co,p as Oo}from"./renderState-zVCpbKXd.js";let $o=class extends Pt{constructor(e,t){super(e,"vec4",mo.Draw,((i,a,s)=>i.setUniform4fv(e,t(a,s))))}};const ye=128,k=.5,pi=Se(k/2,k/2,1-k/2,1-k/2);function hi(o){return o==="cross"||o==="x"}function gi(o,e=ye,t=e*k,i=0){const{data:a,parameters:s}=To(o,e,t,i);return new At(a,s)}function To(o,e=ye,t=e*k,i=0){return{data:Po(o,e,t,i),parameters:{mipmap:!1,wrap:{s:Re.CLAMP_TO_EDGE,t:Re.CLAMP_TO_EDGE},width:e,height:e,components:4,noUnpackFlip:!0,reloadable:!0}}}function Po(o,e=ye,t=e*k,i=0){switch(o){case"circle":default:return Ao(e,t);case"square":return Eo(e,t);case"cross":return zo(e,t,i);case"x":return Ro(e,t,i);case"kite":return yo(e,t);case"triangle":return Fo(e,t);case"arrow":return Io(e,t)}}function Ao(o,e){const t=o/2-.5;return ie(o,at(t,t,e/2))}function Eo(o,e){return ot(o,e,!1)}function yo(o,e){return ot(o,e,!0)}function zo(o,e,t=0){return it(o,e,!1,t)}function Ro(o,e,t=0){return it(o,e,!0,t)}function Fo(o,e){return ie(o,st(o/2,e,e/2))}function Io(o,e){const t=e,i=e/2,a=o/2,s=.8*t,r=at(a,(o-e)/2-s,Math.sqrt(s*s+i*i)),l=st(a,t,i);return ie(o,((u,n)=>Math.max(l(u,n),-r(u,n))))}function ot(o,e,t){return t&&(e/=Math.SQRT2),ie(o,((i,a)=>{let s=i-.5*o+.25,r=.5*o-a-.75;if(t){const l=(s+r)/Math.SQRT2;r=(r-s)/Math.SQRT2,s=l}return Math.max(Math.abs(s),Math.abs(r))-.5*e}))}function it(o,e,t,i=0){e-=i,t&&(e*=Math.SQRT2);const a=.5*e;return ie(o,((s,r)=>{let l,u=s-.5*o,n=.5*o-r-1;if(t){const S=(u+n)/Math.SQRT2;n=(n-u)/Math.SQRT2,u=S}return u=Math.abs(u),n=Math.abs(n),l=u>n?u>a?Math.sqrt((u-a)*(u-a)+n*n):n:n>a?Math.sqrt(u*u+(n-a)*(n-a)):u,l-=i/2,l}))}function at(o,e,t){return(i,a)=>{const s=i-o,r=a-e;return Math.sqrt(s*s+r*r)-t}}function st(o,e,t){const i=Math.sqrt(e*e+t*t);return(a,s)=>{const r=Math.abs(a-o)-t,l=s-o+e/2+.75,u=(e*r+t*l)/i,n=-l;return Math.max(u,n)}}function ie(o,e){const t=new Uint8Array(4*o*o);for(let i=0;i<o;i++)for(let a=0;a<o;a++){const s=a+o*i;let r=e(a,i);r=r/o+.5,Tt(r,t,4*s)}return t}function wo(o){return o instanceof Float32Array&&o.length>=16}function _o(o){return Array.isArray(o)&&o.length>=16}function Do(o){return wo(o)||_o(o)}class Mo{constructor(){this.factor=new Be,this.factorAlignment=new Be}}class Be{constructor(){this.scale=0,this.factor=0,this.minScaleFactor=0}}function jo(o,e){const{vertex:t,fragment:i}=o;o.include(Et,e),t.include(tt),t.main.add(f`vec4 posProjCenter;
